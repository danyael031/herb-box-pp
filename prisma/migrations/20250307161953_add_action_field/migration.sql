...
INSERT INTO "new_History" ("airHumidity", "groundHumidity", "id", "plantId", "temperature", "timestamp") SELECT "airHumidity", "groundHumidity", "id", "plantId", "temperature", "timestamp" FROM "History";
DROP TABLE "History";
